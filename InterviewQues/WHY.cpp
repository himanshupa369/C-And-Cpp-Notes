...
int main(){
     ...
     // why here address of IN and OUT are different .
    /*
    int x{15};
    int y{9};
    int result = sum(x,y);
    ...
    */
    ...
    // why here address of IN and OUT are same .
...
//Answer inside file Getting things out of function "return_by_value.md".
